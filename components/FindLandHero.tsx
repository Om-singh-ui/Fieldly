    ...
    <section className="relative w-full bg-white overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto px-6 py-28 grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-8 z-10">
          <h1 className="text-[40px] sm:text-[48px] lg:text-[56px] font-semibold tracking-[-0.02em] leading-[1.08] text-gray-900">
          ...
          <button
            onClick={handleClick}
            className="inline-flex items-center justify-between gap-4 bg-[#9DB66F] hover:bg-[#8faa61] text-black pl-6 pr-3 py-3 rounded-full text-lg font-medium transition duration-300 shadow-md w-fit"
          >
            <Image
              src="/icons/map.png"
              alt="Land Icon"
        ...
        <div className="relative flex items-center justify-center min-h-[650px]">
          <div className="relative w-[520px] h-[340px] rounded-[40px] overflow-hidden shadow-xl bg-white">
            <Image
              src="/landmap.gif"
              alt="Map"
              fill
