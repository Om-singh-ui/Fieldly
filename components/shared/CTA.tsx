...
function CTASkeleton() {
  return (
    <section className="relative px-6">
      <div className="relative mx-auto max-w-[1200px] rounded-[32px] bg-white px-10 py-10 overflow-visible shadow-[0_30px_80px_rgba(0,0,0,0.25)]">
  ...
  return (
    <section className="relative mt-66 mb-12 px-6">
      <motion.div
        ...
        className="relative mx-auto max-w-[1200px] rounded-[32px] bg-white px-10 py-10 overflow-visible shadow-[0_30px_80px_rgba(0,0,0,0.25)]"
      >
        {/* CONTENT */}
        <div className="relative z-10 max-w-[520px]">
          ...
          <p className="mt-3 text-[16px] leading-relaxed text-black/80">
            ...
            simplify agricultural land leasing through Fieldly’s digital marketplace.
          </p>
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            <button
              ...
              className="
                ...
                focus:ring-black/50 focus:ring-offset-2
              "
            >
              Start Using Fieldly
        ...
        {/* FLOATING IMAGE */}
        <div className="absolute right-8 top-0 -translate-y-1/2 pointer-events-none hidden lg:block">
          <motion.div
            initial={{ opacity: 0, y: 40, scale: 0.95 }}
            whileInView={{ opacity: 1, y: 0, scale: 1 }}
            transition={{ delay: 0.2 }}
            className="relative w-[420px] h-[469px] rounded-[999px] overflow-hidden shadow-[0_40px_60px_rgba(0,0,0,0.35)] group"
          >
            <Image
              src="/cta.png"
