      ...
      <div className="mx-auto grid min-h-screen max-w-[1550px] grid-cols-1 lg:grid-cols-[0.85fr_1.15fr]">
        ...
        >
          ...
          >
            <Link
              href="/"
              className="absolute left-12 top-6 inline-flex items-center gap-1 text-sm text-black hover:text-zinc-600 transition-colors"
            >
              ← Back
            </Link>
          </motion.div>
        ...
        >
          ...
          {/* SignIn Card */}
          <motion.div 
            className="relative mt-14 z-10 rounded-2xl p-2"
