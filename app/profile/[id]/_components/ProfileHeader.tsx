  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="flex gap-3 shrink-0 mt-7 lg:mt-0">
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="
                  group relative rounded-full px-5 h-10
              ...
              >
                <div className="
                  relative bg-black text-white text-xs
                  rounded-lg py-2 px-3 whitespace-nowrap
                  shadow-lg
                ">
        ...
        {/* BIO */}
        {user.bio && (
          <p className="text-sm text-zinc-900 max-w-2xl pt-3 border-t border-border/50">
            {user.bio}
          </p>
        )}
      </motion.div>
