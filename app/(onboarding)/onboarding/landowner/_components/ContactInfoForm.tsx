    ...
    >
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 max-w-md mx-auto text-sm">
          Provide your contact details and location to help us verify your land ownership.
        </p>
      </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700">
              Your contact and location details help us verify your land ownership and 
              connect you with farmers in your region.
            </p>
          </div>
        </div>
      </motion.div>
