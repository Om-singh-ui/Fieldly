...
export function SuccessScreen({ role = "landowner", onContinue }: SuccessScreenProps) {
  const benefits = role === "landowner" ? [
    {
      icon: Shield,
      title: "Profile Verified",
      description: "Your landowner profile is now active and verified.",
    },
    {
      icon: TrendingUp,
      title: "Listing Enabled",
      description: "You can now list your land parcels for leasing.",
    },
    {
      icon: Award,
      title: "Access Unlocked",
      description: "Premium features and verified farmers are available.",
    },
    {
      icon: Users,
      title: "Landowner Network",
      description: "You are now part of our verified landowner community.",
    },
  ] : [
    {
      icon: Shield,
  ...
  const nextSteps = role === "landowner" ? [
    ...
    >
      ...
      <div className="text-center">
        ...
        <p className="text-gray-500 mt-2 max-w-md mx-auto">
          Your onboarding is complete. {role === "landowner" 
      ...
      <div className="text-center">
        <button
          ...
          "
        >
          {role === "landowner" ? "Go to Dashboard" : "Continue to Dashboard"}
