    ...
    <section className="relative w-full overflow-hidden py-16 sm:py-20 text-black">
      ...
      >
        <Image
          ...
          alt="Agriculture insights and data"
          fill
          priority
          ...
          >
            ...
            >
              <h2 className="max-w-2xl text-[40px] sm:text-[48px] font-semibold leading-[1.05] tracking-[-0.01em]">
                ...
                <span className="text-white">Agricultural Markets</span>
              </h2>

              <h2 className="max-w-2xl text-[40px] sm:text-[48px] font-semibold leading-[1.05] tracking-[-0.01em]">
                through Data, Research &{" "}
                <span className="text-black">Real-World Trends</span>
              </h2>
            </motion.div>
          ...
          >
            <div className="space-y-6">
              ...
              <motion.p
                ...
                viewport={{ once: true }}
              >
                Dive into reports, trends, and analysis shaping modern agriculture
                and land markets.
              </motion.p>
