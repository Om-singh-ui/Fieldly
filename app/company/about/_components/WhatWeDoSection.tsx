      ...
      <div className="relative z-20 mx-auto max-w-[1200px] px-4 sm:px-6">
        <div className="grid grid-cols-1 items-start gap-16 lg:grid-cols-[1.3fr_0.7fr]">
          ...
          >
            ...
            >
              By simplifying land discovery, agreements, and farmer
              applications, Fieldly helps unlock productive land and build
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <motion.p
                ...
                viewport={{ once: true }}
              >
                Discover verified farmland opportunities and connect with
