          ...
          <div className="grid grid-cols-1 items-start gap-16 lg:grid-cols-[1.3fr_0.7fr]">
            ...
            >
              ...
              <motion.div className="space-y-3" variants={fadeUp}>
                <h2 className="max-w-2xl text-[42px] sm:text-[48px] font-semibold leading-[1.05]">
                  Invest in Agriculture <span className="text-white">With Confidence</span>
                </h2>

                <h2 className="max-w-2xl text-[42px] sm:text-[48px] font-semibold leading-[1.05]">
                  Empower Farmers <span className="text-black">Through Capital</span>
                </h2>
              </motion.div>
              ...
              >
                Fieldly enables investors to fund verified agricultural opportunities while helping farmers access financial resources.
              </motion.p>
            </motion.div>
            ...
            >
              <div className="space-y-5">
                ...
                <motion.p className="max-w-[220px] text-[13px] leading-relaxed text-black/60">
                  Discover stable agricultural investment opportunities curated by Fieldly.
                </motion.p>
