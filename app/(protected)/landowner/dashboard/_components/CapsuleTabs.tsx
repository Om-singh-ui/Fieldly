...
export function CapsuleTabs({ stats }: CapsuleTabsProps) {
  ...
  return (
    <div className="flex justify-start mt-8" suppressHydrationWarning>
        ...
        {tabs.map((tab) => (
          ...
          >
            ...
            >
              ...
              {tab.badge && (
                <span
                  className={`inline-flex items-center justify-center min-w-[22px] h-5 px-1.5 text-xs font-medium rounded-full ${
                    activeTab === tab.id
